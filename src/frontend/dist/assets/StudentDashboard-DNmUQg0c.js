import { j as jsxRuntimeExports, u as useNavigate, l as loadLocalProfile, r as reactExports } from "./index-DAdiv06a.js";
import { A as AvatarButton, B as Bell, L as LogOut, V as VideoCallModal } from "./VideoCallModal-BqppkGUh.js";
import { B as Badge } from "./badge-DhXbAD2a.js";
import { c as cn, B as Button } from "./button-DDVHHbRn.js";
import { C as Card, a as CardContent } from "./card-C2gOICf_.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog--Yi7JTWz.js";
import { I as Input } from "./input-CGeiywau.js";
import { P as Progress } from "./progress-BILP3UL_.js";
import { S as Search, P as Plus } from "./search-B-_GEugQ.js";
import { X } from "./x-Px92NRaT.js";
import { C as ChevronUp } from "./chevron-up-rfiXfFed.js";
import { C as ChevronDown } from "./chevron-down-guFVZCjJ.js";
import { B as BookOpen } from "./book-open-CdGYZzml.js";
...
import { T as TrendingUp } from "./trending-up-B2ledwNx.js";
import { M as MessageSquare } from "./message-square-C5g85MuN.js";
import { C as Clock } from "./clock-JpZ6stqR.js";
import "./video-DbrgSlPr.js";
import "./monitor-BuDQqIvx.js";
import "./index-Btbju-hn.js";
import "./index-BUloAvc-.js";
import "./Combination-9kXK4-AE.js";
import "./index-nqK2D6pW.js";
import "./index-B5HNZXkj.js";
...
function StudentDashboard() {
  ...
  const [realDoubts, setRealDoubts] = reactExports.useState(() => {
    try {
  ...
  const filteredDoubts = searchQuery.trim().length > 0 ? realDoubts.filter(
    (d) => (d.title ?? "").toLowerCase().includes(searchQuery.toLowerCase()) || (d.subject ?? "").toLowerCase().includes(searchQuery.toLowerCase())
  ) : [];
  ...
  const NotifPanel = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        notifications.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-6 text-center text-sm text-muted-foreground", children: "No notifications yet" }),
        notifications.length > 0 && notifications.every((n) => n.read) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-center text-sm text-muted-foreground", children: "You're all caught up! 🎉" })
      ]
    }
  );
  if (isLoading) {
              ...
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "text-xs border-0 bg-amber-100 text-amber-700", children: "Pending" })
                  ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "student.list", children: realDoubts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          Card,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
                ...
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-1", children: doubt.timestamp ? new Date(doubt.timestamp).toLocaleDateString() : "" })
                    ] }),
              ...
              expandedDoubt === doubt.id && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 pt-4 border-t border-border animate-fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-amber-600", children: [
      ...
      videoCallDoubt !== null && (() => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          VideoCallModal,
          {
            ...
            studentName: ((_a = d == null ? void 0 : d.title) == null ? void 0 : _a.slice(0, 20)) || "Student",
            isTeacher: false
          }
        );
      })()
