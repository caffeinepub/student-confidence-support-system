import { c as createLucideIcon, r as reactExports, u as useNavigate, j as jsxRuntimeExports, L as Link, l as loadLocalProfile } from "./index-pm_agyQj.js";
...
function markRead(id) {
  const list = getNotifications().map(
...
function NotificationBell() {
  ...
  const { notifications, unreadCount, markRead: markRead2, markAllRead: markAllRead2 } = useNotifications();
