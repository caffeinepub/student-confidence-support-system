import { c as createLucideIcon, u as useNavigate, r as reactExports, l as loadLocalProfile, A as AppRole, j as jsxRuntimeExports, e as ue, s as saveLocalProfile, a as saveUserToFirestore, Z as isTeacherInitialized, _ as saveTeacherCode, $ as verifyTeacherCode, a0 as switchRole } from "./index-D2GVQ8nb.js";
import { B as Badge } from "./badge-C8KGgUJ7.js";
import { B as Button } from "./button-DHz_QJks.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription, e as DialogFooter } from "./dialog-BoirFnAG.js";
...
import { U as User } from "./user-DxFjUcwM.js";
...
function ProfilePage() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    const safetyTimer = setTimeout(() => setSaving(false), 1e4);
    try {
  ...
  const handleCreateCodeSubmit = async () => {
    ...
    setSavingCode(true);
    setCodeSetupError("");
    const safetyTimer = setTimeout(() => setSavingCode(false), 5e3);
    try {
      await Promise.race([
